...
private:
	...
	inline static std::map<GLenum, size_t> TYPE_SIZE_MAP = {
		...
		{GL_FLOAT_MAT2, sizeof(float) * 4},
		{GL_FLOAT_MAT2x3,  sizeof(float) * 6},
		{GL_FLOAT_MAT3x2, sizeof(float) * 6},
		{GL_FLOAT_MAT3, sizeof(float) * 9},
		{GL_FLOAT_MAT4, sizeof(float) * 16},
	};
	...
	inline static std::map<GLenum, GLDataTypeInfo> UNIFORM_INFO_MAP =
	{
		...
		{GL_FLOAT_MAT2,        GLDataTypeInfo{ Uniform::DataType::Float,      glm::vec2(2,2), "mat2"}},
		...
		{GL_FLOAT_MAT3,        GLDataTypeInfo{ Uniform::DataType::Float,      glm::vec2(3,3), "mat3"}},
		{GL_FLOAT_MAT4,        GLDataTypeInfo{ Uniform::DataType::Float,      glm::vec2(4,4), "mat4"}},
